...
<html>
<head>
    <title>Главная . 2Polovinka @yield('title')</title>
    <meta charset="UTF-8">
    ...
    <link rel="icon" href="http://blog//themes/default/assets/img/icon.png" type="image/x-icon">
    <link href="http://blog//themes/default/assets/css/materialize.min.css" type="text/css" id="materialize" rel="stylesheet" media="screen,projection"/><link href="http://blog//themes/default/assets/css/plugins.css" type="text/css" id="plugins" rel="stylesheet" media="screen,projection"/><link href="http://blog//themes/default/assets/css/style.css" type="text/css" id="style" rel="stylesheet" media="screen,projection"/><link href="http://blog//themes/default/assets/css/overrides.css" type="text/css" id="overrides" rel="stylesheet" media="screen,projection"/>
    <link href="http://blog//themes/default/assets/css/ie.css" type="text/css" id="ie" rel="stylesheet" media="screen,projection"/>

    <link href="http://blog//themes/default/assets/css/night.css" type="text/css" id="night-mode-css" rel="stylesheet" media="screen,projection"/>

    <script>
        document_title = document.title;

        window.site_url =  "http://blog/";
        window.ajax = "http://blog//aj/";
        window.theme_url = "http://blog//themes/default/";
        window.worker_updateDelay = '4000';
        window.email_notification = '1';
        window.media_path = "http://blog//";
        ...
        var imageAddr = "http://blog//themes/default/assets/img/logof.png" + "?n=" + Math.random();
    ...
    <!-- onesignal -->
    <link rel="manifest" href="http://blog//themes/default/assets/js/OneSignalSDKFiles/manifest.json">
...
<nav role="navigation" id="nav-not-logged-in">
    <div class="nav-wrapper container">
        <div class="left header_logo">
            <a id="logo-container" href="http://blog/" class="brand-logo"><img src="http://blog//themes/default/assets/img/logof.png" /></a>
        </div>
        <ul class="right">
            <li class="hide_mobi_login"><a href="http://blog//login" data-ajax="/login" class="btn-flat waves-effect text-main qdt_hdr_auth_btns">Авторизоваться</a></li>
            <li class="hide_mobi_login"><a href="{{route('auth.register')}}" data-ajax="/register" class="btn-flat btn btn_primary waves-effect waves-light white-text qdt_hdr_auth_btns">регистр</a></li>
            <div class="show_mobi_login">
                ...
                <ul id="log_in_dropdown" class="dropdown-content">
                    <li><a href="{{route('login')}}" data-ajax="/login">Авторизоваться</a></li>
                    <li><a href="{{route('register')}}" data-ajax="/register">регистр</a></li>
                </ul>
            </div>
        </ul>
    </div>
...
<!-- End Header not-logged-in -->        <div id="container">
    ...
    <nav role="navigation">
        <div class="nav-wrapper container">
            <div class="left header_logo">
                <a id="logo-container" href="http://blog//" class="brand-logo"><img src="http://blog//themes/default/assets/img/logo.png" /></a>
            </div>
            <ul class="right not_usr_nav">
                <li class="hide-on-med-and-down black-text">Уже есть аккаунт?</li>
                <li class="hide_mobi_login"><a href="http://blog//login" data-ajax="/login" class="btn-flat btn bold white waves-effect black-text">Авторизоваться</a></li>
                <div class="show_mobi_login">
                    ...
                    <ul id="log_in_dropdown" class="dropdown-content">
                        <li><a href="http://blog//login" data-ajax="/login">Авторизоваться</a></li>
                        <li><a href="http://blog//register" data-ajax="/register">регистр</a></li>
                    </ul>
                </div>
            </ul>
        </div>
    ...
    <div class="container-fluid auth_bg_img">
        <div class="usr_circle sml" style="background-image: url(http://axiomkz.me//themes/default/assets/img/login-sm.jpg);"></div>
        <div class="usr_circle mdm" style="background-image: url(http://axiomkz.me//themes/default/assets/img/login-md.jpg);"></div>
        <div class="usr_circle mlr" style="background-image: url(http://axiomkz.me//themes/default/assets/img/login-ml.jpg);"></div>
        <div class="usr_circle lrg" style="background-image: url(http://axiomkz.me//themes/default/assets/img/register.jpg);"></div>
        <div class="container dt_login_bg">
            <div class="section">
                <div class="dt_login_con">@yield('title')
...
<script src="https://quickdatescript.com/themes/default/assets/js/materialize.min.js" type="text/javascript" id="materialize"/></script><script src="https://quickdatescript.com/themes/default/assets/js/script.js" type="text/javascript" id="script"/></script><script src="https://quickdatescript.com/themes/default/assets/js/plugins.js" type="text/javascript" id="plugins"/></script>	    <div id="max_swap_modal" class="modal dt_swipe_modal_max">
    ...
    <img src="http://axiomkz.me//themes/default/assets/img/max-swipe-alert.svg" alt="близко">
    <div id="max_swap_modal_container"></div>
    </div>
    <div class="modal-footer">
    <a href="http://blog//pro" data-ajax="/pro" class="prema"><span style="margin-left: 9px;">премия</span></a>
...
$(document).on('click', '#night_mode_toggle', function(event) {
    ...
    if (mode == 'night') {
        $('head').append('<link rel="stylesheet" href="http://blog//themes/default/assets/css/night.css?1647" id="night-mode-css">');
...
$(document).on('click', '#night_mode_toggle_sidebar', function(event) {
    mode = $(this).attr('data-mode');
    if (mode == 'night') {
        $('head').append('<link rel="stylesheet" href="http://blog//themes/default/assets/css/night.css?2112" id="night-mode-css">');
